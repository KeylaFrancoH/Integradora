...
// GET para obtener un tema por ID del curso y ID del tema
router.get("/:idCurso/:idTema", async (req, res) => {
...
router.put("/:id", async (req, res) => {
  const { idCurso, Titulo, Subtitulo, Material } = req.body;
  try {
    const [updated] = await Tema.update(
      { idCurso, Titulo, Subtitulo, Material },
      {
